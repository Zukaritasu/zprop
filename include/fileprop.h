...
typedef void *pzprop;
	...
	ZPEXPORT bool zp_replace(pzprop prop, cstr_t key, cstr_t value);
	...
	/* Las siguientes funciones convierte el valor en el tipo de dato que
	   ...
	   El valor para la funcion 'zp_bool' puede ser "true" o '1' para indicar
	   un valor true, todo distinto de eso es false */
	...
	/* Crea un espacio en memoria para el handle. La funcion puede
	   retornar false si ocurre un error al solicitar memoria */
